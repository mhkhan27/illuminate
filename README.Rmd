...
survey_frequency_by_choices() provides the count by each choice. suppose in the following example we have a dataset of 40 observation including the  reponder gender and upazila.
